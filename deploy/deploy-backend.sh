...
# ===== 应用配置 =====
APP_PORT="${SERVER_PORT:-8082}"  # 应用端口（从环境变量读取）
...
# 构建数据库URL
DB_URL="jdbc:mysql://$DB_HOST:$DB_PORT/$DB_NAME?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true"

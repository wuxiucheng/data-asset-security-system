...
export const statisticsApi = {
  // 获取资产统计
  getAssetStatistics() {
    return http.get<Statistics>('/classificationAssistStatistics/overview')
  },
...
export const classificationAssistRuleApi = {
  // 分页查询
  getList(params: any) {
    return http.post('/classificationAssistRule/page', params)
  },

  // 根据ID查询
  getById(ruleId: number) {
    return http.get(`/classificationAssistRule/${ruleId}`)
  },

  // 新增
  create(data: any) {
    return http.post('/classificationAssistRule', data)
  },

  // 更新
  update(data: any) {
    return http.put('/classificationAssistRule', data)
  },

  // 删除
  delete(ruleId: number) {
    return http.delete(`/classificationAssistRule/${ruleId}`)
  },

  // 启用
  enable(ruleId: number) {
    return http.put(`/classificationAssistRule/${ruleId}/enable`)
  },

  // 禁用
  disable(ruleId: number) {
    return http.put(`/classificationAssistRule/${ruleId}/disable`)
  },

  // 获取启用的规则列表
  getActiveRules() {
    return http.get('/classificationAssistRule/active')
  }
}
...
export const classificationAssistTaskApi = {
  // 分页查询
  getList(params: any) {
    return http.post('/classificationAssistTask/page', params)
  },

  // 创建
  create(data: any) {
    return http.post('/classificationAssistTask', data)
  },

  // 更新
  update(data: any) {
    return http.put('/classificationAssistTask', data)
  },

  // 删除
  delete(taskId: number) {
    return http.delete(`/classificationAssistTask/${taskId}`)
  },

  // 执行任务
  execute(taskId: number) {
    return http.post(`/classificationAssistTask/${taskId}/execute`)
  },

  // 取消任务
  cancel(taskId: number) {
    return http.post(`/classificationAssistTask/${taskId}/cancel`)
  }
}
...
export const classificationAssistResultApi = {
  // 分页查询
  getList(params: any) {
    return http.post('/classificationAssistResult/page', params)
  },

  // 批准
  approve(resultId: number, comment?: string) {
    return http.post(`/classificationAssistResult/${resultId}/approve`, null, { params: { comment } })
  },

  // 拒绝
  reject(resultId: number, comment?: string) {
    return http.post(`/classificationAssistResult/${resultId}/reject`, null, { params: { comment } })
  },

  // 批量审核
  batchReview(resultIds: number[], status: string, comment?: string) {
    return http.post('/classificationAssistResult/batchReview', resultIds, { params: { status, comment } })
  },

  // 获取待审核数量
  getPendingCount() {
    return http.get('/classificationAssistResult/pendingCount')
  }
}

    ...
    <el-aside width="200px" class="layout-aside">
      ...
      >
        ...
        <el-sub-menu index="asset">
          ...
          <el-menu-item index="/classification-assist-rule">分类分级辅助</el-menu-item>
          <el-menu-item index="/classification-assist-task">执行任务</el-menu-item>
          <el-menu-item index="/classification-assist-result">结果审核</el-menu-item>
        </el-sub-menu>
        ...
        <el-sub-menu index="governance">
          ...
          <el-menu-item index="/mask-whitelist">脱敏白名单</el-menu-item>
          <el-menu-item index="/quality-rule">质量规则</el-menu-item>
          <el-menu-item index="/quality-task">质量探查任务</el-menu-item>
          <el-menu-item index="/quality-alert">质量告警</el-menu-item>
          <el-menu-item index="/lineage">数据血缘</el-menu-item>
          <el-menu-item index="/lifecycle">生命周期</el-menu-item>
          <el-menu-item index="/compliance">数据标准与合规</el-menu-item>
        </el-sub-menu>

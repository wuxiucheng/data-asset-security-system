...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'classification-assist-rule',
        name: 'ClassificationAssistRule',
        component: () => import('@/views/classification-assist/rule/index.vue'),
        meta: { title: '分类分级辅助规则', requiresAuth: true },
      },
      {
        path: 'mask-strategy',
        name: 'MaskStrategy',
      ...
      },
      {
        path: 'mask-whitelist',
        name: 'MaskWhitelist',
        component: () => import('@/views/mask-whitelist/index.vue'),
        meta: { title: '脱敏白名单', requiresAuth: true },
      },
      {
        path: 'quality-rule',
        name: 'QualityRule',
      ...
      },
      {
        path: 'quality-alert',
        name: 'QualityAlert',
        component: () => import('@/views/quality-alert/index.vue'),
        meta: { title: '质量告警', requiresAuth: true },
      },
      {
      ...
      },
      {
        ...
        meta: { title: '数据血缘', requiresAuth: true },
      },
      {
        path: 'lifecycle',
        name: 'Lifecycle',
        component: () => import('@/views/lifecycle/index.vue'),
        meta: { title: '生命周期', requiresAuth: true },
      },
      {
        path: 'compliance',
        name: 'Compliance',
        component: () => import('@/views/compliance/index.vue'),
        meta: { title: '数据标准与合规', requiresAuth: true },
      },
      {
        path: 'classification-assist-rule',
        name: 'ClassificationAssistRule',
        component: () => import('@/views/classification-assist/rule/index.vue'),
        meta: { title: '分类分级辅助', requiresAuth: true },
      },
      {
        path: 'classification-assist-task',
        name: 'ClassificationAssistTask',
        component: () => import('@/views/classification-assist/task/index.vue'),
        meta: { title: '执行任务', requiresAuth: true },
      },
      {
        path: 'classification-assist-result',
        name: 'ClassificationAssistResult',
        component: () => import('@/views/classification-assist/result/index.vue'),
        meta: { title: '结果审核', requiresAuth: true },
      },
    ],
  },
]
